...
async def get_quantitative_score(ticker):
    ...
    try:
        ...
        if score >= 5: score += 2; details.append("버핏초이스")
...
if __name__ == "__main__":
    import uvicorn
    # Use environment variables for port if available, default to 8000
    # Host 0.0.0.0 is required for internet accessibility
